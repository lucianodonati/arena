...
public class Menu : MonoBehaviour {
    ...
    Texture2D m_tSelectedButton;
    Texture2D m_tDefaultButton;
    public string hover;
        ...
        for (int i = 0; i < 3; i++)
			{
                ...
                if (GUI.Button(new Rect(Screen.width / 2.0f - 250, 300 + 150*i, 500, 50.0f), new GUIContent(options[i],options[i]), style)) 
                {
                    if (m_nSelection == 0)
                    {
